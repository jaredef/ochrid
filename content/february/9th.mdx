---
description: 'February 9th'
title: 'The Holy Martyr Nicephorus, Hieromartyr Peter Damascene'
---
...
## THE HIEROMARTYR <span style={{color:'crimson', fontSize:'80%'}}>[PRIEST-MARTYR]</span> PETER DAMASCENE
