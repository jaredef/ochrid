...
title: 'Hieromartyr Autunomus, Hieromartyr Coronatus, Bishop of Iconium, Holy Martyr Julian with Forty Companions, Venerable Daniel of Thasos'
---
...
# <div id="date">September <Image className="four-dot" src="/four-dot.png" height={15} width={15} alt="Four dot" />12</div>
