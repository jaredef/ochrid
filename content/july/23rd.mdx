---
description: 'July 23rd'
title: 'The Holy Martyrs Trophimus and Theophilus, and Thirteen Others with Them, Hieromartyr Apollinarius'
---
...
## THE HOLY HIEROMARTYR <span style={{color:'crimson', fontSize:'80%'}}>[PRIEST-MARTYR]</span> APOLLINARIUS
