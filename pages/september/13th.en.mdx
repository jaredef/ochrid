...
title: 'Consecration of the Church of the Resurrection of Christ, Hieromartyr Cornelius the Centurion, Holy Martyrs Macrobius and Gordian'
---
...
## THE HOLY HIEROMARTYR <span style={{color:'crimson', fontSize:'%'}}>[PRIEST-MARTYR]</span> CORNELIUS THE CENTURION
