---
title: 'April 8th'
description: 'The Holy Apostles Herodian, Agabus, Rufus, Asyncritus, Phlegon and Hermes, St. Niphon, Bishop of Novgorod, St. Celestine, Pope of Rome'
---
...
# <div id="date">April <Image className="four-dot" src="/four-dot.png" height={15} width={15} alt="Four dot" />8</div>
