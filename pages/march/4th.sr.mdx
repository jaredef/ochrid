---
title: 'March 4th'
description: 'The Venerable Gerasimus, Holy Martyrs Paul and Juliana, St. James the Faster'
---
...
# <div id="date">March <Image className="four-dot" src="/four-dot.png" height={15} width={15} alt="Four dot" />4</div>
