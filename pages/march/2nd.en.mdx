---
title: 'March 2nd'
description: 'Hieromartyr Theodotus, Bishop of Cyrenia, Holy Martyr Troadius, The 440 Martyrs slain by the Lombards, Venerable Agathon, Martyr Euthalia'
---
...
# <div id="date">March <Image className="four-dot" src="/four-dot.png" height={15} width={15} alt="Four dot" />2</div>
