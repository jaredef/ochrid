---
title: 'January 6th'
description: 'The Theophany of Our Lord and Savior Jesus Christ'
---
...
## 1. THE THEOPHANY <span style={{color:'crimson', fontSize:'80%'}}>[EPIPHANY]</span> OF OUR LORD AND SAVIOR JESUS CHRIST
