---
title: 'January 5th'
description: 'Priest-Martyr Theopemptos and the Martyr Theonas, the Prophet Micah the First, Venerable Mother Syncletica, Venerable Apollinaria'
---
...
# <div id="date">January <Image className="four-dot" src="/four-dot.png" height={15} width={15} alt="Four dot" />5</div>

## 1. THE HIEROMARTYR <span style={{color:'crimson', fontSize:'80%'}}>[PRIESTLY-MARTYR]</span><br />THEOPEMPTOS AND THE MARTYR THEONAS
