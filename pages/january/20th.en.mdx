---
title: 'January 20th'
description: 'The Venerable Euthymius the Great, the Holy Martyrs Inna, Nirra, and Pinna'
---
...
# <div id="date">January <Image className="four-dot" src="/four-dot.png" height={15} width={15} alt="Four dot" />20</div>
