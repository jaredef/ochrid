---
title: 'January 4th'
description: 'Synaxis of the Seventy Apostles, St Eustathius, Archbishop of the Serbs, The Eunuch of Queen Candace, St. Onuphrius of Hilandar'
---
...
## 1. THE SYNAXIS <span style={{color:'crimson', fontSize:'80%'}}>[ASSEMBLY]</span> OF THE SEVENTY HOLY APOSTLES
...
## 2. EUSTATHIUS <span style={{color:'crimson', fontSize:'80%'}}>[JEVSTATIJE]</span>, ARCHBISHOP OF THE SERBS
...
## 4. THE VENERABLE MARTYR ONUPHRIUS OF HILANDAR MONASTERY <span style={{color:'crimson', fontSize:'80%'}}>[MOUNT ATHOS]</span>
