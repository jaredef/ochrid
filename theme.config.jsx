  ...
  head: () => {
        ...
        return (
          <>
            ...
            <meta property="twitter:description" content={(frontMatter.description ? frontMatter.description + ', Prologue — The Orthodox Christian Devotional' : 'Prologue — The Orthodox Christian Devotional')}></meta>
            <meta property="twitter:title" content={frontMatter.title || 'Lives of Saints, Hymns, Reflections and Homilies for Every Day of the Year'}></meta>
